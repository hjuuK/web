...
public class Book implements Comparable<Book> {
    ...
    @Override
    public int hashCode() {
        //return super.hashCode(); // 기본값은 객체 주소
        
        return Objects.hash(title, author, publisher); // hashCode() 재정의
    }

    @Override
    public boolean equals(Object obj) {
        //return super.equals(obj); // 기본값은 객체 주소
        
        if(obj instanceof Book) { // equals() 재정의
            Book book = (Book) obj;
